<!-- Space: Projects -->
<!-- Parent: ZshScmBreeze -->
<!-- Title: Contributing GithubFlow ZshScmBreeze -->
<!-- Label: ZshScmBreeze -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-scmbreeze project on [GitHub](https://github.com/luismayta/zsh-scmbreeze), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-scmbreeze/pulls).
...
To follow the instructions in this guide and start contributing to zsh-scmbreeze project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-scmbreeze.git
```

Now your **upstream** points to **luismayta/zsh-scmbreeze**.
...
git fetch upstream # assuming upstream is luismayta/zsh-scmbreeze
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-scmbreeze/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
